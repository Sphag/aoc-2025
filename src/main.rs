...
fn main() {
    ...
    task7::execute_part1_from_input("inputs/task7.txt");
    task7::execute_part2_from_input("inputs/task7.txt");

    task8::execute_part1_from_input("inputs/task8.txt");
    task8::execute_part2_from_input("inputs/task8.txt");
}